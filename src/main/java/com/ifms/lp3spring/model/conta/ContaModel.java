...
public abstract class ContaModel {
	...
	// Verifica se a conta possui cartão de débito 
	public boolean getPossuiCartaoDebito() {
		return cartoes.stream().anyMatch(cartao -> cartao instanceof DebitoModel);
	}
	...
	public void sacar(double valor) {
		...
		double saldoDisponivel = saldoAtual + getLimite();
